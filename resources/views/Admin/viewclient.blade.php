                                ...
                                <form class="form">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="eventRegInput1" class="form-control" value={{$client->name}} @disabled(true)>
                                        </div>

                                        <div class="form-group">
                                            <label for="eventRegInput2">Client ID</label>
                                            <input type="text" id="eventRegInput2" class="form-control" value={{$client->email}} @disabled(true)>
                                        </div>

                                        <div class="form-group">
                                            <label for="eventRegInput3">Password</label>
                                            <input type="text" id="eventRegInput3" class="form-control" value={{$client->password}} @disabled(true)>
                                        </div>                                       
