                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <form class="form" action="/projectstore" method="Post">
                                    @csrf
                                    <div class="form-body">

                                        <div class="form-group">
                                            <label for="eventRegInput1">Project Name</label>
                                            <input type="text" id="eventRegInput1" class="form-control" placeholder="Project Name" name="name">
                                        </div>

                                        <div class="form-group">
                                            <label for="eventRegInput2">Project Description</label>
                                            <textarea id="eventRegInput2" class="form-control" placeholder="Enter Description about Project" name="description"></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="eventRegInput3">Project Under User</label>
